...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                ...
                searchable=True, value= "ALL",options=[{'label': 'All Sites', 'value': 'ALL'},{'label': 'CCAFS SLC-40', 'value': 'CCAFS SLC-40'},{'label': 'VAFB SLC-4E', 'value': 'VAFB SLC-4E'},{'label': 'KSC LC-39A', 'value': 'KSC LC-39A'},{'label': 'CCAFS LC-40', 'value': 'CCAFS LC-40'},]),
                                html.Br(),
...
def get_scatter_chart(entered_site,payload_range):
    filtered_df = spacex_df
    data = filtered_df[filtered_df['Payload Mass (kg)'].between(payload_range[0],payload_range[1])]
    if entered_site == 'ALL':
